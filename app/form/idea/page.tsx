        ...
        <div className="w-full">
            <div className="lg:w-[50vw] md:mx-auto sm:px-4 md:px-12 py-12 flex flex-col flex-nowrap bg-gray-100 text-black">
                ...
                <div className="w-full flex flex-col flex-nowrap mx-auto my-2 fade-in text-black">
                    ...
                    <textarea name={form?.section1.question1.key} value={form?.section1.question1.answer} onChange={e => updateAnswer(form?.section1.question1.key, e.target.value)} rows={2} placeholder="e.g. The product ..." className="mx-4 my-2 px-3 py-4 text-lg rounded-md border border-gray-400" />
                    <label htmlFor={form?.section1.question2.key} className="mx-4 px-2 pt-4 font-bold">{form?.section1.question2.question}</label>
                    <textarea name={form?.section1.question2.key} value={form?.section1.question2.answer} onChange={e => updateAnswer(form?.section1.question2.key, e.target.value)} rows={2} placeholder="e.g. An Ideal customer ..." className="mx-4 my-2 px-3 py-4 text-lg rounded-md border border-gray-400" />
                    <label htmlFor={form?.section1.question3.key} className="mx-4 px-2 pt-4 font-bold">{form?.section1.question3.question}</label>
                    <textarea name={form?.section1.question3.key} value={form?.section1.question3.answer} onChange={e => updateAnswer(form?.section1.question3.key, e.target.value)} rows={2} placeholder="e.g. The market ..." className="mx-4 my-2 px-3 py-4 text-lg rounded-md border border-gray-400" />
                    <label htmlFor={form?.section1.question4.key} className="mx-4 px-2 pt-4 font-bold">{form?.section1.question4.question}</label>
                    <textarea name={form?.section1.question4.key} value={form?.section1.question4.answer} onChange={e => updateAnswer(form?.section1.question4.key, e.target.value)} rows={2} placeholder="e.g. The product is unique because ..." className="mx-4 my-2 px-3 py-4 text-lg rounded-md border border-gray-400" />
                    <label htmlFor={form?.section1.question5.key} className="mx-4 px-2 pt-4 font-bold">{form?.section1.question5.question}</label>
                    <textarea name={form?.section1.question5.key} value={form?.section1.question5.answer} onChange={e => updateAnswer(form?.section1.question5.key, e.target.value)} rows={2} placeholder="e.g. The biggest barriers ..." className="mx-4 my-2 px-3 py-4 text-lg rounded-md border border-gray-400" />
                </div>
